...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    ...
    let help_embed = new MessageEmbed()
      ...
      .setDescription(" • Prefix for this server is `n?`\n• Total commands: 78\n• [Invite](https://discord.com/oauth2/authorize?client_id=1135247834346701010&permissions=8&scope=bot) | [Join](https://www.dsc.gg/theshadowrealm)\n > 🤴 **__My Categories are__** :\n\n >>>   🏠  Home\n📺  Channel\n😄  Fun\n🎮   Games\nℹ️   Information\n🆙  Level\n🛠️  Moderation\n🎵  Music\n⚙️  Settings\n🔧  Utility")
      .addField("🤴 **__STATS:__**",
